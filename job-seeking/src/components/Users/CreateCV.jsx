...
const CreateCV = () => {
    ...
    return (
        ...
        <Row>
            ...
            <Col md={6}>
                ...
                <Form.Group controlId="careerObjective">
                    ...
                    <Form.Control as="textarea" rows={5} name="careerObjective" value={formData.careerObjective} onChange={handleChange} />
                </Form.Group>
            </Col>
            ...
            <Col md={6}>
                ...
                <Form.Group controlId="university">
                    ...
                    <Form.Control type="text" name="university" value={formData.university} onChange={handleChange} />
                </Form.Group>
                <Form.Group controlId="graduationYear">
                    <Form.Label>Graduation Year:</Form.Label>
                    <Form.Control type="number" name="graduationYear" value={formData.graduationYear} onChange={handleChange} />
                </Form.Group>
        ...
        <Row>
            <Col md={6}>
                ...
                <Form.Group controlId="technicalSkills">
                    ...
                    <Form.Control type="text" name="technicalSkills" value={formData.technicalSkills} onChange={handleSkillsChange} />
                </Form.Group>
                <Form.Group controlId="softSkills">
                    <Form.Label>Soft Skills:</Form.Label>
                    <Form.Control type="text" name="softSkills" value={formData.softSkills} onChange={handleSkillsChange} />
                </Form.Group>
            </Col>
        </Row>
        ...
        <div className="text-center mt-4">
            <Button variant="primary" type="submit">Create CV</Button>
        </div>
    </Form>
